...
public interface PaperHooks {
  void doSomething(org.slf4j.Logger logger);
  ...
  final class Holder {
    ...
    static {
      ...
      try {
        ...
        hooks = (PaperHooks) Class.forName("oi.yeetaaron1.org.paper_" + underscored + ".PaperHooks" + underscored).getDeclaredConstructors()[0].newInstance();
